...
import homeworks.homework2.server.ServerControllerImpl;

public class ClientController implements ClientControllerImpl {
    private final ServerControllerImpl serverController;
    private final ClientViewImpl clientView;
    private boolean isConnected;
    private final String clientName;

    public ClientController(ServerControllerImpl serverController, ClientViewImpl clientView, String clientName) {
