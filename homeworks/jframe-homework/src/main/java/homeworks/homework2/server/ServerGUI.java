...
public class ServerGUI extends JFrame implements ServerViewImpl {
    ...
    private ServerControllerImpl serverController;
    ...
    @Override
    public void setController(ServerControllerImpl controller) {
